...
class EnergySystem(QWidget):
    ...
    def __init__(self):
        ...
        # Map
        self.map = folium.Map(location=[50.9375, 6.9603], zoom_start=11)
        data = io.BytesIO()
        ...
        self.layout.addWidget(self.project_name_l, 0, 0)
        self.layout.addWidget(self.project_name, 0, 1, 1, 5)
        self.layout.addWidget(self.start_time_l, 1, 0)
        self.layout.addWidget(self.start_time, 1, 1, 1, 5)
        self.layout.addWidget(self.end_time_l, 2, 0)
        self.layout.addWidget(self.end_time, 2, 1, 1, 5)
        self.layout.addWidget(self.time_step_l, 3, 0)
        self.layout.addWidget(self.time_step, 3, 1, 1, 5)
        self.layout.addWidget(self.latitude_l, 4, 0)
        self.layout.addWidget(self.latitude, 4, 1)
        self.layout.addWidget(self.longitude_l, 4, 2)
        self.layout.addWidget(self.longitude, 4, 3)
        self.layout.addWidget(self.altitude_l, 4, 4)
        self.layout.addWidget(self.altitude, 4, 5)
        self.layout.addWidget(self.terrain_l, 7, 0)
        self.layout.addWidget(self.terrain, 7, 1, 1, 5)
        self.layout.addWidget(self.d_rate_l, 8, 0)
        self.layout.addWidget(self.d_rate, 8, 1, 1, 5)
        self.layout.addWidget(self.lifetime_l, 9, 0)
        self.layout.addWidget(self.lifetime, 9, 1, 1, 5)
        self.layout.addWidget(self.grid_l, 10, 0)
        self.layout.addWidget(self.grid, 10, 1, 1, 5)
        self.layout.addWidget(self.blackout_l, 11, 0)
        self.layout.addWidget(self.blackout, 11, 1)
        self.layout.addWidget(self.blackout_data_l, 11, 2)
        self.layout.addWidget(self.blackout_data, 11, 3, 1, 3)
        self.layout.addWidget(self.electricity_price_l, 12, 0)
        self.layout.addWidget(self.electricity_price, 12, 1, 1, 5)
        self.layout.addWidget(self.co2_price_l, 13, 0)
        self.layout.addWidget(self.co2_price, 13, 1, 1, 5)
        self.layout.addWidget(self.feed_in_l, 14, 0)
        self.layout.addWidget(self.feed_in, 14, 1, 1, 5)
        self.layout.addWidget(self.pv_feed_l, 15, 0)
        self.layout.addWidget(self.pv_feed, 15, 1)
        self.layout.addWidget(self.wt_feed_l, 15, 2)
        self.layout.addWidget(self.wt_feed, 15, 3, 1, 3)
        self.layout.addWidget(self.co2_grid_l, 17, 0)
        self.layout.addWidget(self.co2_grid, 17, 1, 1, 5)
        self.layout.addWidget(self.map_viewer, 18, 0, 1, 6)
