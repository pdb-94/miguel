...
class DG(QWidget):
    ...
    def __init__(self):
        ...
        self.layout.addWidget(self.fuel_l, 2, 0, Qt.AlignTop)
        self.layout.addWidget(self.fuel, 2, 1, Qt.AlignTop)
        self.layout.addWidget(self.invest_l, 3, 0, Qt.AlignTop)
        self.layout.addWidget(self.invest, 3, 1, Qt.AlignTop)
        self.layout.addWidget(self.op_main_l, 4, 0, Qt.AlignTop)
        self.layout.addWidget(self.op_main, 4, 1, Qt.AlignTop)
        self.layout.addWidget(self.c_var_l, 5, 0, Qt.AlignTop)
