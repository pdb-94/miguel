...
class EnergyStorage(QWidget):
    ...
    def __init__(self):
        ...
        self.layout.addWidget(self.p_l, 1, 0, Qt.AlignTop)
        self.layout.addWidget(self.p, 1, 1, Qt.AlignTop)
        self.layout.addWidget(self.c_l, 2, 0, Qt.AlignTop)
        self.layout.addWidget(self.c, 2, 1, Qt.AlignTop)
        self.layout.addWidget(self.soc_l, 3, 0, Qt.AlignTop)
        self.layout.addWidget(self.soc, 3, 1, Qt.AlignTop)
        self.layout.addWidget(self.soc_min_l, 4, 0, Qt.AlignTop)
        self.layout.addWidget(self.soc_min, 4, 1, Qt.AlignTop)
        self.layout.addWidget(self.soc_max_l, 5, 0, Qt.AlignTop)
        self.layout.addWidget(self.soc_max, 5, 1, Qt.AlignTop)
        self.layout.addWidget(self.n_charge_l, 6, 0, Qt.AlignTop)
        self.layout.addWidget(self.n_charge, 6, 1, Qt.AlignTop)
        self.layout.addWidget(self.n_discharge_l, 7, 0, Qt.AlignTop)
        self.layout.addWidget(self.n_discharge, 7, 1, Qt.AlignTop)
        self.layout.addWidget(self.lifetime_l, 8, 0, Qt.AlignTop)
        self.layout.addWidget(self.lifetime, 8, 1, Qt.AlignTop)
        self.layout.addWidget(self.invest_l, 9, 0, Qt.AlignTop)
        self.layout.addWidget(self.invest, 9, 1, Qt.AlignTop)
        self.layout.addWidget(self.opm_l, 10, 0, Qt.AlignTop)
