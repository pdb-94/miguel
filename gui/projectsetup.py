...
class ProjectSetup(QWidget):
    ...
    def __init__(self):
        ...
        gui_func.create_pixmap(path=root + '/documentation/MiGUEL_logo.png', widget=self.miguel_logo, w=640, h=480)
        self.th_logo = QLabel()
        gui_func.create_pixmap(path=root + '/documentation/th-koeln.png', widget=self.th_logo, w=160, h=160)
        self.enershelf_logo = QLabel()
        gui_func.create_pixmap(path=root + '/documentation/EnerSHelF_logo.png', widget=self.enershelf_logo, w=160, h=160)
        # Description
